  ...
  return (
    <section className="bg-deep-navy text-white">
      <div className="mx-auto max-w-6xl px-5 py-16">
        ...
        <h2 className="mt-2 text-center text-2xl font-bold md:text-3xl">상담 가능한 브랜드와 제품</h2>
        <p className="mx-auto mt-3 max-w-2xl text-center text-sm leading-relaxed text-gray-300">
